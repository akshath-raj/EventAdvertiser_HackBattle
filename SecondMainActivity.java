...
public class SecondMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clubsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SecondMainActivity.this, YourClubs.class);
                startActivity(intent);
            }
        });
        ...
        eventsLV.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position==0){
                    ...
                    Intent intent1=new Intent(SecondMainActivity.this, ListVTwo.class);
                    startActivity(intent1);
                }
            }
        });
